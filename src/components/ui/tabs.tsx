      ...
      >
        {propTabs.map((tab, idx) => (
          <button
            ...
            className={cn("relative px-6 py-2 rounded-md font-mulish text-sm", tabClassName)}
            style={{
          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn(
                  "absolute inset-0 bg-gray-200 dark:bg-[#171717] font-inter font-medium rounded-xl border-2 border-solid border-[#333]",
                  activeTabClassName
                )}
              />
            )}
