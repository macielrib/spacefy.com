...
export function NossosTrabalhos() {
  const tabs = [
    ...
    {
      title: "Site de Finanças",
      value: "financial",
      content: (
        <>
          <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-purple-700 to-violet-900 lg:bg-[#171717] lg:border-4 lg:border-solid lg:border-[#171717] lg:bg-[url('/portfolio/png/greenleaf.png')] lg:bg-no-repeat lg:bg-cover">
            <div className="lg:hidden">
              <FinancialImagem />
            </div>
          </div>
